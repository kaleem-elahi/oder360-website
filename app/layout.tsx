  ...
  return (
    <html lang="en-AE" dir="ltr" data-theme="dark">
      <head>
        ...
        <Script id="google-tag-manager" strategy="afterInteractive">
          {`
            ...
            })(window,document,'script','dataLayer','GTM-PJHS3G4L');
          `}
        </Script>
        {/* Meta Pixel Code */}
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: 'none' }}
            src="https://www.facebook.com/tr?id=1257190809494541&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
      </head>
      <body className={`${inter.variable} ${cairo.variable} ${inter.className}`}>
        ...
        <noscript>
          <iframe 
            src="https://www.googletagmanager.com/ns.html?id=GTM-PJHS3G4L"
            height="0" 
            width="0" 
